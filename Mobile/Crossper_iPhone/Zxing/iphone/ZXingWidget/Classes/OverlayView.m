...
- (void)drawRect:(CGRect)rect {
  ...
  //  self.displayedMessage = @"Place a QR Code inside the viewfinder rectangle to scan it.";
    ...
    [[UIImage imageNamed:@"Background.png"] drawInRect:CGRectMake(0, -7, self.frame.size.width, self.frame.size.height)];
  ...
  //	CGContextSetStrokeColor(c, white);
	...
	if (oneDMode) {
		char *text = "Place a red line over the QR code to be scanned.";
