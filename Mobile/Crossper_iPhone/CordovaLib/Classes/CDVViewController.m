...
//        NSURLRequest* appReq = [NSURLRequest requestWithURL:appURL cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:20.0];
        NSURLRequest *urlRequest = [NSURLRequest requestWithURL:appURL];
...
{
     NSLog(@"webViewDidStartLoad : %@", [theWebView.request URL]);
...
{
    NSLog(@"webViewDidFinishLoad : %@", [theWebView.request URL]);
    /*
...
{
   NSLog(@"shouldStartLoadWithRequest : %@", [theWebView.request URL]);
