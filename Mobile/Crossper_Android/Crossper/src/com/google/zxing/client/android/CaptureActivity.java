...
//  };
  ...
  protected void onResume() {
    ...
    Log.i("Shyam", "dataString "+dataString+" intent.getDataString() "+intent.getDataString() );
    if (intent != null && action != null) {
      if (action.equals(Intents.Scan.ACTION)) {
        // Scan the formats the intent requested, and return the result to the calling activity.
        source = Source.NATIVE_APP_INTENT;
        Log.i("Crossper", "Action intent");
        ...
        Log.i("Crossper", "producet search link");
        ...
        Log.i("Crossper", "Action ZXING_LINK");
      } else {
...
//        return true;
//      }
    	Log.i("Crossper","onKeyDown keyCode Back");
//    	if (keyCode == KeyEvent.KEYCODE_BACK) {
    	  ...
    	  Log.i("Crossper","Source.NONE or Source.Zxing link");
        resetStatusView();
        if (handler != null) {
...
//  
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent intent) {
    if (resultCode == RESULT_OK) {
    	Log.i("Crossper", "onActivityResult");
...
//	    ResultHandler resultHandler = ResultHandlerFactory.makeResultHandler(this, rawResult);
	    Log.i("Shyam", " handleDecode source "+source);
//	if (source == Source.NATIVE_APP_INTENT) {
	        Intent resultIntent = new Intent();
	        resultIntent.putExtra(Constants.EXTRA_URL, rawResult.toString());
...
//        	  Log.i("Crossper"," handleDecodeInternally ZXING_LINK");
...
//            resetStatusView();
//          } else {
//        	  Log.i("Crossper","case NONE handleDecodeInternally ZXING_LINK");
//            handleDecodeInternally(rawResult, resultHandler, barcode);
//          }
//          break;
//      }
//    }
  ...
  private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
	  Log.i("Crossper","handleDecodeInternally");
	  Intent intent = new Intent();
	  intent.putExtra(Intents.Scan.RESULT, rawResult.getBarcodeFormat().toString());
